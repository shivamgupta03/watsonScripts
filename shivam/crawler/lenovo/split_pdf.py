...
def write_file(path, initial_page, final_page):
    ...
    file_path = '/Users/shivam/compressedTemppdf/{}_page_{}-{}.pdf'.format(pdf_name, initial_page + 1, final_page + 1)
...
def split_file(path):
    try:
        ...
        for i in range(inputpdf.numPages):
            output.addPage(inputpdf.getPage(i))
            temp_file_path = '/Users/shivam/compressedTemppdf/tempo.pdf'
...
hardware_manuals_path = '/Users/shivam/temppdf'
...
# split_file('/Users/shivam/compressedTemppdf/11e_5thgen_and_yoga11e_5thgen_hmm_en.pdf')
